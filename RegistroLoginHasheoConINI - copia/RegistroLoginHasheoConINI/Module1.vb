...
Module Module1
    ...
    'Funciones Auxiliares: son funciones que aprovechan funciones pre-existentes del
    ' sistema mediante un nombre más sencillo para facilitar su uso. La clausula
    ...
    Private Declare Unicode Function EscribirDatosINI Lib "kernel32" _
        ...
        (NombreAplicacion As String, NombreClave As String, ValorClave As String, ArchivoINI As String) As Int32
    ...
    Private Declare Unicode Function LeerDatosINI Lib "kernel32" _
        ...
        (NombreAplicacion As String, NombreClave As String, ValorPorDescarte As String, _
